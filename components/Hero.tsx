            ...
            <div className="max-w-7xl space-y-3 mx-auto px-2 relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2  gap-20 items-center">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="rounded-3xl md:rounded-none md:rounded-s-3xl xp-4 md:py-4 relative">
                            ...
                            <h1 className="text-black text-xl md:text-4xl lg:text-6xl font-bold mt-8">
                                QUANTUM
                                <span className='gradient-text mx-2'>BLOCKS</span>

                            </h1>
                            <p className='text-normal mt-4 leading-relaxed'>
                                The next evolution in blockchain technology, offering a transformative
